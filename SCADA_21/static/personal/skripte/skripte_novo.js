	...
	$('#id_stanica').change(function () {
		...
		//alert(value);
			...
			$.ajax({
				...
				success: function (data) {
					opcijeZaMjerenje =  '<option value="-1">Odaberite prvo mjerenje:</option>';
					...
					$("#id_mjerenje_drugo").html(opcijeZaMjerenje2);
...
$('#id_mjerenje_drugo').change(function () {
		var value3 = $(this).val();
